...
parser.add_option('--m1', help='number of beads in chain. Default=%default', dest='m1', type='float', default=2)
parser.add_option('--a11', help='guess for aii. Default=%default', dest='a11', type='float', default=10)
#
...
m1	=	opts.m1
a11	=	opts.a11
print rcg.aijterm(a11,rhom1,m1,l1,a22,rhom2,m2,l2)
